...
class DismissibleHelper extends StatefulWidget {
  ...
  @override
  State<DismissibleHelper> createState() => _DismissibleState();
}
...
class _DismissibleState extends State<DismissibleHelper> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  @override
  void initState() {
    super.initState();
