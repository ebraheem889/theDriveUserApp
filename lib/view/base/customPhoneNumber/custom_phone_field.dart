...
import 'package:the_drive/view/base/customPhoneNumber/PickerDialog.dart';
import 'package:the_drive/view/base/customPhoneNumber/phone_number.dart';

import './countrs.dart';
import './phone_number.dart' as phone;
...
class CustomPhoneField extends StatefulWidget {
  ...
  final ValueChanged<SingleCountry>? onCountryChanged;
  ...
  /// & pick dialog
  final PickerDialogSty? pickerDialogStyle;
...
class _CustomPhoneFieldState extends State<CustomPhoneField> {
  late List<SingleCountry> _countryList;
  late SingleCountry _selectedCountry;
  late List<SingleCountry> filteredCountries;
  late String number;
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      // parse initial value
      _selectedCountry = countrs.firstWhere(
  ...
  Future<void> _changeCountry() async {
    ...
    await showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (ctx, setState) => PickerDialog(
          style: widget.pickerDialogStyle,
          filteredCountries: filteredCountries,
          searchText: widget.searchText,
          countryList: _countryList,
          selectedCountry: _selectedCountry,
          onCountryChanged: (SingleCountry country) {
      ...
      return GetBuilder<RegisterController>(builder: ((registerController) {
        return TextFormField(
          ...
          onChanged: (value) async {
            ...
            authcontroller.setphoneData(phone: phoneNumber);
            registerController.setphoneData(phone: phoneNumber);
