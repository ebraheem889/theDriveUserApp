...
import 'package:the_drive/view/base/customPhoneNumber/countrs.dart';

class PickerDialogSty {
...
class PickerDialog extends StatefulWidget {
  ...
  final List<SingleCountry> filteredCountries;
  final PickerDialogSty? style;
...
class _PickerDialogState extends State<PickerDialog> {
  late List<SingleCountry> _filteredCountries;
